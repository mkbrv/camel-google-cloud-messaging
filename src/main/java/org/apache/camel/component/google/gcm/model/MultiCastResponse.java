...
public final class MultiCastResponse implements Serializable {
    ...
    private final List<GCMResponse> results;
    private final List<Long> retryMulticastIds;

    public static final class Builder {

        private final List<GCMResponse> results = new ArrayList<GCMResponse>();
        ...
        public Builder addResult(GCMResponse result) {
            results.add(result);
            return this;
        }
     ...
     */
    public List<GCMResponse> getResults() {
        return results;
    }
